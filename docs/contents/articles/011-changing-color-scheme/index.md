...
We tried to make the process of changing color scheme in BoliviaHubFrontend as easy as possible. 

By default BoliviaHubFrontend has two color profiles: mint and blur.
This article will help you to create your own color profile.
Let's say you want to make BoliviaHubFrontend dark.
